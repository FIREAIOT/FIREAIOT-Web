                                        ...
                                        <div class="login-form animated preFadeInLeft fadeInLeft">
                                            <div class="field pb-10">
                                                <div class="control has-icons-right">
                                                    <input class="input is-large" type="password" placeholder="New Password" required autocomplete="false" v-model="password">
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-right">
                                                    <input class="input is-large" type="password" placeholder="Comfirm password" required autocomplete="false" v-model="confirmPassword" >
                                                    <span class="icon is-medium is-right">
                                                <i class="im im-icon-Key-2"></i>
                                            </span>
                                                </div>
                                            ...
                                            <p class="control login">
                                                <button type="submit" class="button button-cta secondary-btn btn-outlined is-fullwidth raised no-lh" >Reset Password</button>
                                            </p>
                                        </div>
                                    </form>
                                    <!-- Request password form -->
    ...
    export default {
        ...
        methods: {
            ...
            showResetSuccessMessage() {
                this.$toast.success('Success!', 'Your password has been reset! Please login now!', {
