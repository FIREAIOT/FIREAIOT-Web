                    ...
                    <div class="hero-heading">
                        <div class="section intro-section has-text-centered no-padding-bottom animated preFadeInLeft fadeInLeft">
                            <router-link :to="{ name: 'home' }">
                                <img class="top-logo" src="/images/logo.svg" alt="MySenior logo">
                            </router-link>
                            <div id="signup-intro" class="intro-text">
                                <div class="intro-title">MySenior</div>
                                        ...
                                        <div class="login-form animated preFadeInLeft fadeInLeft">
                                            <div class="field pb-10">
                                                <div class="control has-icons-right">
                                                    <input class="input is-large" type="email" placeholder="Email address" required autocomplete="false" v-model="email">
                                            ...
                                            <p class="control login">
                                                <button type="submit" class="button button-cta secondary-btn btn-outlined is-fullwidth raised no-lh">Email Reset Instructions</button>
                                            </p>
                                        </div>
                                    </form>
                                    <!-- Request password form -->
    ...
    export default {
        ...
        methods: {
            submit() {
                ...
                axios.post('/password/request', { email : this.email })
                .then(() => {
                    loadingComponent.close()
                    this.showPasswordRequestSuccessMessage()
                    this.redirectToHome()
                })
                .catch(() => {
                    loadingComponent.close()
                    this.showPasswordRequestErrorMessage()
                })
            },
            showPasswordRequestSuccessMessage() {
                this.$toast.success('Success!', 'Recovery email has been sent! Please follow the instructions', {
             ...
             showPasswordRequestErrorMessage() {
                this.$toast.error('Opps!', 'Something went wrong, please check your email!', {
                    position: 'topRight',
                    titleColor: '#fff',
                    messageColor: '#fff',
