...
return [
    ...
    */
    ...
    'repository'   => [
        'provider' => 'github',
        'url'      => 'https://github.com/fireaiot/server'
    ],
    ...
    */
    ...
    'ui'                 => [
        'show_app_name'  => true,
        'logo'           => '/images/logo.png', // e.g.: /images/logo.svg
        'fav'            => '/favicon.png', // e.g.: /fav.png
        'theme'          => 'light',
        'code'           => 'light',
        'back_to_top'    => true,
        'show_side_bar'  => true,
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Saleem Hadad',
        'description'     => 'Autonomous IoT-based Firefighting UAV Ecosystem',
        'keywords'        => 'Binary Torch, Engineering, IT, software, machine vision, image processing, Robotics',
        'og'              => [
            'title'       => 'FIREAIOT',
            'type'        => 'article',
            'url'         => '',
